    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manufacturer_name',
                 models.CharField(max_length=100, unique=True, verbose_name='Наименование производителя')),
                ('country', models.CharField(blank=True, max_length=40, verbose_name='Страна')),
                ('slug', models.SlugField(max_length=100, unique=True, verbose_name='URL')),
                ('photo', models.ImageField(default='shop/static/img/favicon.svg', upload_to='img_category/%Y/%m/%d/',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='shop.manufacturer',
                                   verbose_name='Производитель')),
                ('product_characteristic',
                 sortedm2m.fields.SortedManyToManyField(help_text=None, to='shop.characteristic',
                                                        verbose_name='Характеристики')),
                ('product_photos', sortedm2m.fields.SortedManyToManyField(help_text=None, to='shop.product_images',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=100, unique=True, verbose_name='URL')),
                ('category_name',
                 models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='shop.category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments',
                                              to='shop.product', verbose_name='Продукты')),
